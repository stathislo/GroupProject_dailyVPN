...
import "./Moderator_Users.css"
import axios from 'axios'
 
export default class Moderator_Users extends Component {
 constructor(props){
 super(props)
 this.steate = {
 ...
 <h2 className="text-post">Show all users</h2>
 <div>
 <button type="Submit" className="show-button">Users</button>
 </div>
 </div>
