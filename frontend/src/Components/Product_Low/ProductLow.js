        ...
        return (
            ...
            <div className='secure'>
                ...
                <div className="container-account">
                    ...
                    <div className="w-100"></div>
                        <div className="row justify-content-around">
                            <input id="email-input" onChange={this.onEmailChange} className="input-email col-6" type="email" placeholder="enter your email" name="useremail"></input>
                ...
                <div className="accordion-body card-paypal-body">
                    <div className="row justify-content-between"> 
                        <div className="col-6"> Your subscription - 2 Year Plan </div>
